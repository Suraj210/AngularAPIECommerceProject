    ...
    public class OrderService : IOrderService
    {
        ...
        public async Task<ListOrder_DTO> GetAllOrdersAsync(int page, int size)
        {
            ...
            var data2 = from order in data
                        join comletedOrder in _completedOrderReadRepository.Table
                          on order.Id equals comletedOrder.OrderId into co
        ...
        public async Task<SingleOrder_DTO> GetOrderByIdAsync(string id)
        {
