...
export class SignalRService {
  constructor(@Inject('baseSignalRUrl') private baseSiganlRUrl: string) {}
  ...
  start(hubUrl: string) {
    hubUrl = this.baseSiganlRUrl + hubUrl;
    if (
      !this.connection ||
    ...
    this._connection.onclose((erro) => console.log('Close reconnection'));
  }
  invoke(
